                ...
                <form action="/" className='h-1/2 flex flex-col gap-6 border-b-[1px]'>
                    ...
                    <div className='w-1/2 flex flex-col gap-6'>
                        <label htmlFor="name" className='flex items-center gap-x-4 w-full'>
                            <p title='Nombre' className='flex items-start w-2/5'>Razón Social<span className='text-[10px] text-danger ml-2'>(*)</span></p>
                            <input type="text" name="name" id="name" placeholder='Ingrese la razón social' autoComplete='name' required className='w-3/5 h-[30px] border-none bg-gray/[0.2] px-4 rounded-lg' />
                        </label>
                        <label htmlFor="address" className='flex items-center gap-x-4'>
                            <p title='Domicilio' className='flex items-start w-2/5'>Domicilio<span className='text-[10px] text-danger ml-2'>(*)</span></p>
                            <input type="text" name="address" id="address" placeholder='Ingrese el domicilio' autoComplete='address' required className='w-3/5 h-[30px] border-none bg-gray/[0.2] px-4 rounded-lg' />
                        </label>
                        <label htmlFor="dni" className='flex items-center gap-x-4'>
                            ...
                            <input type="text" name="dni" id="dni" placeholder='Ingrese el DNI' autoComplete='DNI' required className='w-3/5 h-[30px] border-none bg-gray/[0.2] px-4 rounded-lg' />
                        </label>
                    </div>
                </form>
                <form action="/" className='h-1/2 flex flex-col gap-6 pt-4'>
                    ...
                    <div className='w-1/2 flex flex-col gap-6'>
                        <label htmlFor="email" className='flex items-center gap-x-4'>
                            ...
                            <input type="text" name="email" id="email" placeholder='Ingrese el correo' autoComplete='email' required className='w-3/5 h-[30px] border-none bg-gray/[0.2] px-4 rounded-lg' />
                        </label>
                        <label htmlFor="phone" className='flex items-center gap-x-4'>
                            <p title='Telefono' className='flex items-start w-2/5'>Teléfono</p>
                            <input type="text" name="phone" id="phone" placeholder='Ingrese el telefono' autoComplete='phone' className='w-3/5 h-[30px] border-none bg-gray/[0.2] px-4 rounded-lg' />
                        </label>
                    </div>
                </form>
            </section>
