  ...
  return (
    <div className='ml-[250px] relative h-screen w-auto'>
      <header className='w-full h-[74px] flex items-center justify-between px-6 border-b-2 border-white bg-dark-minus'>
        ...
        <Link to={'/providers/new'} className='text-white bg-primary w-[100px] h-1/2 rounded-lg hover:bg-blue/50 flex items-center justify-center hover:bg-primary/40 hover:shadow-md'>Nuevo</Link>
      </header>
              ...
              <table className='h-[200px] w-full mb-[1rem] table-auto overflow-y-scroll overflow-x-scroll'>
                <thead>
                  <tr className='leading-[1.5rem]'>
                    <th className='border-y-[1px] border-white p-[0.3rem] text-left pl-4'>Razon Social</th>
                    <th className='border-y-[1px] border-white p-[0.3rem] text-left pl-4'>Domicilio</th>
                ...
                <tbody>
                  <tr className='bg-dark/[0.4] align-top border-b-[1px]'>
                    <td className='text-left pl-4 pt-3'>Razon Social</td>
                    <td className='text-left pl-4 pt-3'>Domicilio</td>
